...
\end{equation}
but there is another constraint which doesn't require $a_0$ to be different from $0$, given by
\begin{equation}
...
with
\begin{equation}
    W = \text{diag} \sigma_e^{-r}.
\end{equation}
The parameter $r$ is then chosen in $[0; 1]$ where a value close to $0$ corresponds to the GTLS estimator.
