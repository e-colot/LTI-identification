...
The resulting FRFs are plotted in Fig.~\ref{fig:EstimatedFRF}. It can be seen that the LLS and TLS estimators have \textit{bumps} where poles and zeros nearly cancel each other's. The three last estimators (GTLS, BTLS and ML) superpose perfectly, making them undistinguishable on the graph.
